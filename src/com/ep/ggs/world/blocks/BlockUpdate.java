 ...
 * {@link Player#GlobalBlockChange(BlockUpdate[], ClassicLevel, com.ep.ggs.server.Server)} </br>
 * {@link Player#GlobalBlockChange(BlockUpdate[], ClassicLevel, com.ep.ggs.server.Server, boolean)} </br>
