...
public class ServerMessage extends Packet {
	...
	public ServerMessage(String name, byte ID, PacketManager parent,
			PacketType packetType) {
		super(name, ID, parent, packetType);
		// TODO Auto-generated constructor stub
	}
	
	public ServerMessage(PacketManager pm) {
		super("ServerMessage", (byte)0x0d, pm, PacketType.Server_to_Client);
	}
